...
/* package haskess-0.1.0.0 */
#ifndef VERSION_haskess
#define VERSION_haskess "0.1.0.0"
#endif /* VERSION_haskess */
#ifndef MIN_VERSION_haskess
#define MIN_VERSION_haskess(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskess */
...
#define CURRENT_COMPONENT_ID "haskess-0.1.0.0-inplace-haskess"
